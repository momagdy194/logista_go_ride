                        ...
                        children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text("Asynchronous user", style: GoogleFonts.cairo(fontWeight: FontWeight.w600)),
                                Row(
                                  children: [
                                    Expanded(
                                      child: Row(
                                        children: [
                                          ...
                                          Text(Constant.calculateReview(reviewCount: "0.0", reviewSum: "0.0"), style: GoogleFonts.cairo(fontWeight: FontWeight.w500)),
                                        ],
                                      ),
                                    ),
                                    Text(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(driverModel.fullName.toString(), style: GoogleFonts.cairo(fontWeight: FontWeight.w600)),
                              Row(
                                children: [
                                  Expanded(
                                    child: Row(
