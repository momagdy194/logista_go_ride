...
import 'package:customer/custom_ride/model/stripe_failed_model.dart';
...
import 'package:customer/custom_ride/payment/MercadoPagoScreen.dart';
import 'package:customer/custom_ride/payment/PayFastScreen.dart';
import 'package:customer/custom_ride/payment/RazorPayFailedModel.dart';
import 'package:customer/custom_ride/payment/getPaytmTxtToken.dart';
import 'package:customer/custom_ride/payment/paystack/pay_stack_screen.dart';
import 'package:customer/custom_ride/payment/paystack/pay_stack_url_model.dart';
import 'package:customer/custom_ride/payment/paystack/paystack_url_genrater.dart';
...
class IntercityPaymentOrderController extends GetxController {
  ...
  flutterWaveInitiatePayment({required BuildContext context, required String amount}) async {
    final flutterWave = Flutterwave(
      ...
      customization: Customization(title: "Logista"),
      txRef: _ref!,
