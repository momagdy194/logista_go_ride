...
import 'package:customer/custom_ride/controller/on_boarding_controller.dart';
                                      ...
                                      child: Column(
                                        children: [
                                          Text(
                                            ...
                                            style: GoogleFonts.cairo(fontSize: 18, fontWeight: FontWeight.w600, letterSpacing: 1.5),
                                          ),
                                          const SizedBox(
                                            height: 10,
                                          ),
                                          Padding(
                                            ...
                                            child: Text(
                                              ...
                                              style: GoogleFonts.cairo(fontWeight: FontWeight.w400, letterSpacing: 1.5),
                                            ),
                                          ),
                                        ],
                                      ),
