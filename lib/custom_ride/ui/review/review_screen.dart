...
import 'package:customer/custom_ride/controller/rating_controller.dart';
...
import 'package:customer/custom_ride/widget/my_separator.dart';
          ...
          return Scaffold(
            ...
            body: controller.isLoading.value == true
                ...
                : Stack(
                    children: [
                      Padding(
                        padding:   EdgeInsets.only(left: 20, right: 20, top: 42, bottom: 20),
                        child: Card(
                          elevation: 2,
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Text(
                                    ...
                                    style: GoogleFonts.cairo(letterSpacing: 0.8, fontWeight: FontWeight.w800),
                                  ),
                                  const SizedBox(
                                    height: 8,
                                  ),
                                  ...
                                  Row(
                                    ...
                                    crossAxisAlignment: CrossAxisAlignment.center,
                                    children: [
                                      Text("${controller.driverModel.value.vehicleInformation!.vehicleNumber}", style: GoogleFonts.cairo(fontWeight: FontWeight.w700)),
                                      const SizedBox(
                                        width: 10,
                                      ),
                                      Text("${controller.driverModel.value.vehicleInformation!.vehicleType}", style: GoogleFonts.cairo(fontWeight: FontWeight.w500)),
                                      const SizedBox(
                                        width: 10,
                                      ),
                                      Text("${controller.driverModel.value.vehicleInformation!.vehicleColor}", style: GoogleFonts.cairo(fontWeight: FontWeight.w700)),
                                    ],
                                  ),
                                  const SizedBox(
                                    height: 20,
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      'Rate for'.tr,
                                      textAlign: TextAlign.center,
                                      style: GoogleFonts.cairo(letterSpacing: 0.8),
                                    ),
                                  ),
                                  Padding(
