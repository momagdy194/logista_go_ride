...
import 'package:customer/custom_ride/controller/wallet_controller.dart';
...
import 'package:customer/custom_ride/ui/intercityOrders/intercity_complete_order_screen.dart';
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      "Total Balance".tr,
                                      style: GoogleFonts.cairo(color: Colors.white, fontWeight: FontWeight.w600, fontSize: 16),
                                    ),
                                    Text(
                                      Constant.amountShow(amount: controller.userModel.value.walletAmount.toString()),
                                      style: GoogleFonts.cairo(color: Colors.white, fontWeight: FontWeight.w600, fontSize: 24),
                                    ),
                                  ],
                                ),
                              ),
