...
import 'package:customer/custom_ride/ui/intercityOrders/intercity_accept_order_screen.dart';
import 'package:customer/custom_ride/ui/intercityOrders/intercity_complete_order_screen.dart';
import 'package:customer/custom_ride/ui/intercityOrders/intercity_payment_order_screen.dart';
                                                          ...
                                                          Container(
                                                            ...
                                                            child: Padding(
                                                                ...
                                                                child: Center(
                                                                  child: Row(
                                                                    children: [
                                                                      Expanded(child: Text(orderModel.status.toString(), style: GoogleFonts.cairo(fontWeight: FontWeight.w600))),
