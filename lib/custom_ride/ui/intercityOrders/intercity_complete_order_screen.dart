...
import 'package:customer/custom_ride/controller/intercity_complete_order_controller.dart';
                                          ...
                                          child: Container(
                                            ...
                                            child: Padding(
                                                ...
                                                child: Center(
                                                  child: Row(
                                                    children: [
                                                      Expanded(child: Text(controller.orderModel.value.status.toString(), style: GoogleFonts.cairo(fontWeight: FontWeight.w500))),
                                                      Text(Constant().formatTimestamp(controller.orderModel.value.createdDate), style: GoogleFonts.cairo()),
                                                    ],
                                                  ),
                                                )),
                                          ),
