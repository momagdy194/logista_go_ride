...
import 'package:customer/custom_ride/controller/intercity_payment_order_controller.dart';
...
import 'package:customer/custom_ride/payment/createRazorPayOrderModel.dart';
import 'package:customer/custom_ride/payment/rozorpayConroller.dart';
import 'package:customer/custom_ride/themes/app_colors.dart';
import 'package:customer/custom_ride/themes/responsive.dart';
import 'package:customer/custom_ride/ui/coupon_screen/coupon_screen.dart';
                                                    ...
                                                    Row(
                                                      children: [
                                                        Expanded(
                                                          child: Text(
                                                            "Ride Amount".tr,
                                                            style: GoogleFonts.cairo(color: AppColors.subTitleColor),
                                                          ),
                                                        ),
                                                        Text(
                                                        ...
                                                        Row(
                                                          children: [
                                                            Text(
                                                              ...
                                                              style: GoogleFonts.cairo(fontWeight: FontWeight.w600, color: Colors.red),
                                                            ),
                                                          ],
                                                        ),
                                                      ],
                                              ...
                                              child: Row(
                                                children: [
                                                  ...
                                                  Text("(${Constant.amountShow(amount: controller.userModel.value.walletAmount.toString())})",
                                                      style: GoogleFonts.cairo(color: themeChange.getThem() ? AppColors.darkModePrimary : AppColors.primary)),
                                                  Radio(
