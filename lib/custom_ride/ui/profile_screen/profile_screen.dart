...
import 'package:customer/custom_ride/controller/profile_controller.dart';
import 'package:customer/custom_ride/controller/profile_controller.dart';
                    ...
                    child: Stack(
                      ...
                      children: [
                        Positioned(
                          bottom: 50,
                          child: Center(
                            child: (controller.profileImage?.isEmpty??true)
                                ? ClipRRect(
                                        ...
                                        children: [
                                          ...
                                          ButtonThem.buildButton(
                                            ...
                                            onPress: () async {
                                              ...
                                              if (controller.profileImage?.value.isNotEmpty==true&&controller.profileImage?.value!=null&&controller.profileImage?.value.toString()!="null") {
                                                print("controller.profileImage.value ${controller.profileImage?.value!="null"?true:false}");
