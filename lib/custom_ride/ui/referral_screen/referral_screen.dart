...
import 'package:customer/custom_ride/controller/referral_controller.dart';
import 'package:customer/custom_ride/controller/referral_controller.dart';
...
class ReferralScreen extends StatelessWidget {
                            ...
                            child: Column(
                              children: [
                                ...
                                Text(
                                  ...
                                  style: GoogleFonts.cairo(fontWeight: FontWeight.w600, color: themeChange.getThem() ? Colors.white : Colors.black, fontSize: 22),
                                ),
                              ],
                            ),
                          ),
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      "Invite Friend & Businesses".tr,
                                      style: GoogleFonts.cairo(fontWeight: FontWeight.w600, fontSize: 20),
                                    ),
                                    const SizedBox(
                                      height: 5,
                                    ),
                                    Text(
                                      "Invite Logista to sign up using your link and you’ll get ${Constant.amountShow(amount: Constant.referralAmount.toString())}  ".tr,
                                      style: GoogleFonts.cairo(fontWeight: FontWeight.w200),
                                    ),
                                    const SizedBox(
                                      height: 30,
                                    ),
                                        ...
                                        child: Padding(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Text("Tap to Copy".tr, style: GoogleFonts.cairo(fontWeight: FontWeight.w200))
                                            ],
                                          ),
                                        ),
                                      ),
  ...
  Future<void> share(ReferralController controller) async {
    ...
    await FlutterShare.share(
      title: 'Logista'.tr,
      text:
      'Hey there, thanks for choosing Logista. Hope you love our product. If you do, share it with your friends using code ${controller.referralModel.value.referralCode.toString()} and get ${Constant.amountShow(amount: Constant.referralAmount)}.'.tr,
    );
  }
}
