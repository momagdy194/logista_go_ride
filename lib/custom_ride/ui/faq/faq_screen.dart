              ...
              child: Padding(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text("FAQs".tr, style: GoogleFonts.cairo(fontSize: 20, fontWeight: FontWeight.w600)),
                      Text("Read FAQs solution".tr, style: GoogleFonts.cairo()),
                      const SizedBox(
                        height: 20,
                      ),
                      Expanded(
                                        ...
                                        return InkWell(
                                          ...
                                          child: Padding(
                                            ...
                                            child: Container(
                                              ...
                                              child: ExpansionTile(
                                                title: Text(faqModel.title.toString(), style: GoogleFonts.cairo()),
                                                children: <Widget>[
                                                  ListTile(
                                                    title: Text(faqModel.description.toString(), style: GoogleFonts.cairo()),
                                                  ),
                                                ],
                                              ),
                                            ),
