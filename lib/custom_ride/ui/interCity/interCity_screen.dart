...
import 'package:customer/custom_ride/controller/interCity_controller.dart';
          ...
          body: controller.isLoading.value
              ...
              : Column(
                  children: [
                    ...
                    Expanded(
                      child: Container(
                        decoration: BoxDecoration(color: Theme.of(context).colorScheme.background, borderRadius: const BorderRadius.only(topLeft: Radius.circular(10), topRight: Radius.circular(10))),
                        child: Padding(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text("Select Option".tr, style: GoogleFonts.cairo(fontWeight: FontWeight.w500, letterSpacing: 1)),
                                  const SizedBox(
                                    height: 05,
                                  ),
                                  SizedBox(
                                      ...
                                      : controller.selectedInterCityType.value.id == "Kn2VEnPI3ikF58uK8YqY"
                                          ? Column(
                                              children: [
                                                ...
                                                // Row(
                                                //   children: [
                                                //     Expanded(child: Text("Loader needed".tr, style: GoogleFonts.cairo(fontWeight: FontWeight.w500, letterSpacing: 1))),
