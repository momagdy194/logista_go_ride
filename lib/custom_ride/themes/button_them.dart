      ...
      child: SizedBox(
        ...
        child: MaterialButton(
          ...
          child: Text(
            ...
            style: GoogleFonts.cairo(fontSize: txtSize, fontWeight: FontWeight.w600),
          ),
        ),
      ),
    );
          ...
          child: Row(
            ...
            children: [
              ...
              Text(
                title.toUpperCase(),
                textAlign: TextAlign.center,
                style: GoogleFonts.cairo(color: themeChange.getThem() ? AppColors.darkModePrimary : AppColors.primary, fontSize: txtSize, fontWeight: FontWeight.w600),
              ),
            ],
          ),
        ),
      ...
      child: SizedBox(
        ...
        child: MaterialButton(
          ...
          child: Text(
            title.toUpperCase(),
            textAlign: TextAlign.center,
            style: GoogleFonts.cairo(color: txtColor, fontSize: txtSize, fontWeight: FontWeight.w600),
          ),
        ),
      ),
    );
