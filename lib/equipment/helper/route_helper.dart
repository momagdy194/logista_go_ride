...
import 'package:customer/equipment/data/model/response/parcel_category_model.dart';
...
import 'package:customer/equipment/util/html_type.dart';
import 'package:customer/equipment/view/base/image_viewer_screen.dart';
import 'package:customer/equipment/view/base/not_found.dart';
import 'package:customer/equipment/view/screens/address/add_address_screen.dart';
import 'package:customer/equipment/view/screens/address/address_screen.dart';
import 'package:customer/equipment/view/screens/auth/delivery_man_registration_screen.dart';
import 'package:customer/equipment/view/screens/auth/store_registration_screen.dart';
import 'package:customer/equipment/view/screens/auth/sign_in_screen.dart';
import 'package:customer/equipment/view/screens/auth/sign_up_screen.dart';
import 'package:customer/equipment/view/screens/cart/cart_screen.dart';
import 'package:customer/equipment/view/screens/category/category_item_screen.dart';
import 'package:customer/equipment/view/screens/category/category_screen.dart';
import 'package:customer/equipment/view/screens/chat/chat_screen.dart';
import 'package:customer/equipment/view/screens/chat/conversation_screen.dart';
import 'package:customer/equipment/view/screens/checkout/checkout_screen.dart';
import 'package:customer/equipment/view/screens/checkout/order_successful_screen.dart';
import 'package:customer/equipment/view/screens/checkout/payment_screen.dart';
import 'package:customer/equipment/view/screens/coupon/coupon_screen.dart';
import 'package:customer/equipment/view/screens/dashboard/dashboard_screen.dart';
import 'package:customer/equipment/view/screens/item/item_campaign_screen.dart';
import 'package:customer/equipment/view/screens/item/item_details_screen.dart';
import 'package:customer/equipment/view/screens/item/popular_item_screen.dart';
import 'package:customer/equipment/view/screens/forget/forget_pass_screen.dart';
import 'package:customer/equipment/view/screens/forget/new_pass_screen.dart';
import 'package:customer/equipment/view/screens/forget/verification_screen.dart';
import 'package:customer/equipment/view/screens/html/html_viewer_screen.dart';
import 'package:customer/equipment/view/screens/interest/interest_screen.dart';
import 'package:customer/equipment/view/screens/language/language_screen.dart';
import 'package:customer/equipment/view/screens/location/access_location_screen.dart';
import 'package:customer/equipment/view/screens/location/map_screen.dart';
import 'package:customer/equipment/view/screens/location/pick_map_screen.dart';
import 'package:customer/equipment/view/screens/notification/notification_screen.dart';
import 'package:customer/equipment/view/screens/onboard/onboarding_screen.dart';
import 'package:customer/equipment/view/screens/order/order_details_screen.dart';
import 'package:customer/equipment/view/screens/order/order_screen.dart';
import 'package:customer/equipment/view/screens/order/order_tracking_screen.dart';
import 'package:customer/equipment/view/screens/order/refund_request_screen.dart';
import 'package:customer/equipment/view/screens/parcel/parcel_category_screen.dart';
import 'package:customer/equipment/view/screens/parcel/parcel_location_screen.dart';
import 'package:customer/equipment/view/screens/parcel/parcel_request_screen.dart';
import 'package:customer/equipment/view/screens/profile/profile_screen.dart';
import 'package:customer/equipment/view/screens/profile/update_profile_screen.dart';
import 'package:customer/equipment/view/screens/refer_and_earn/refer_and_earn_screen.dart';
import 'package:customer/equipment/view/screens/store/all_store_screen.dart';
import 'package:customer/equipment/view/screens/store/campaign_screen.dart';
import 'package:customer/equipment/view/screens/store/store_item_search_screen.dart';
import 'package:customer/equipment/view/screens/store/store_screen.dart';
import 'package:customer/equipment/view/screens/store/review_screen.dart';
import 'package:customer/equipment/view/screens/search/search_screen.dart';
import 'package:customer/equipment/view/screens/splash/splash_screen.dart';
import 'package:customer/equipment/view/screens/support/support_screen.dart';
import 'package:customer/equipment/view/screens/taxi_booking/booking_checkout_screen/booking_checkout_screen.dart';
import 'package:customer/equipment/view/screens/taxi_booking/car_details_screen/car_details_screen.dart';
import 'package:customer/equipment/view/screens/taxi_booking/order_status_screen/order_status_screen.dart';
import 'package:customer/equipment/view/screens/taxi_booking/select_car_screen.dart';
import 'package:customer/equipment/view/screens/taxi_booking/select_map_location/select_map_location.dart';
import 'package:customer/equipment/view/screens/taxi_booking/taxi_coupon_screen/taxi_coupon_screen.dart';
import 'package:customer/equipment/view/screens/taxi_booking/trip_completed_confermation/trip_completed_confirmation_screen.dart';
import 'package:customer/equipment/view/screens/taxi_booking/trip_history/trip_history_screen.dart';
import 'package:customer/equipment/view/screens/update/update_screen.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:customer/equipment/view/screens/wallet/wallet_screen.dart';
...
class RouteHelper {
  ...
  static String getCategoryItemRoute(
    int? id,
    String name,
  ) {
  ...
  static List<GetPage> routes = [
    GetPage(
        ...
        page: () => getRoute(DashboardScreen(
            pageIndex: 0,
            fromSplash: Get.parameters['from-splash'] == 'false'))),
    GetPage(
        name: splash,
        page: () {
  ...
  static Widget getRoute(Widget navigateTo,
    ...
    if (GetPlatform.isAndroid) {
      minimumVersion =
          Get.find<EQSplashControllerEquip>().configModel!.appMinimumVersionAndroid;
    } else if (GetPlatform.isIOS) {
      minimumVersion =
          Get.find<EQSplashControllerEquip>().configModel!.appMinimumVersionIos;
    }
    return AppConstants.appVersion < minimumVersion!
        ? const UpdateScreen(isUpdate: true)
        : Get.find<EQSplashControllerEquip>().configModel!.maintenanceMode!
            ? const UpdateScreen(isUpdate: false)
            : Get.find<EQLocationController>().getUserAddress() == null
