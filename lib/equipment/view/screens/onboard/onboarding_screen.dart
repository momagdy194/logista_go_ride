...
class _OnBoardingScreenState extends State<OnBoardingScreen> {
  ...
  void initState() {
    ...
    Get.find<EQOnBoardingController>().getOnBoardingList();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<EQOnBoardingController>(
              ...
              child: Row(children: [
                onBoardingController.selectedIndex == 2 ? const SizedBox() : Expanded(
                  child: CustomButton(
                    transparent: true,
                    onPressed: () {
                      Get.find<EQSplashControllerEquip>().disableIntro();
  ...
  List<Widget> _pageIndicators(EQOnBoardingController onBoardingController, BuildContext context) {
