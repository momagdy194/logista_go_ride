...
import 'package:customer/equipment/view/screens/checkout/widget/slot_widget.dart';
        ...
        children: [
          ...
          Flexible(
            child: SingleChildScrollView(
              ...
              child: GetBuilder<EQOrderController>(
                          ...
                          Row(children: [
                            Expanded(
                              child: tobView(context:context, title: 'today'.tr, isSelected: orderController.selectedDateSlot == 0, onTap: (){
                                orderController.updateDateSlot(0, Get.find<EQStoreController>().store!.orderPlaceToScheduleInterval);
                              }),
                            ),

                            Expanded(
                              child: tobView(context:context, title: 'tomorrow'.tr, isSelected: orderController.selectedDateSlot == 1, onTap: (){
                                orderController.updateDateSlot(1, Get.find<EQStoreController>().store!.orderPlaceToScheduleInterval);
                              }),
                            ),
                          ]),
                            ...
                            ? orderController.timeSlots!.isNotEmpty ? GridView.builder(
                              ...
                              itemBuilder: (context, index){
                                String time = (index == 0 && orderController.selectedDateSlot == 0
                                    ...
                                    && (Get.find<EQSplashControllerEquip>().configModel!.moduleConfig!.module!.orderPlaceToScheduleInterval! ? storeController.store!.orderPlaceToScheduleInterval == 0 : true))
