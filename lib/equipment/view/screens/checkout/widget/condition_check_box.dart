...
class CheckoutCondition extends StatelessWidget {
  final EQOrderController orderController;
  final EQParcelController parcelController;
  final bool isParcel;
  ...
  Widget build(BuildContext context) {
    bool activeRefund = Get.find<EQSplashControllerEquip>().configModel!.refundPolicyStatus == 1;
    return Row(children: [
      // SizedBox(
      //   width: 24.0,
      //   height: 24.0,
