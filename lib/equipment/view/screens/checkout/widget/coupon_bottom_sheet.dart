    ...
    return Container(
      ...
      child: SingleChildScrollView(
        ...
        child: Column(children: [
          ...
          GetBuilder<EQCouponController>(builder: (couponController){
              ...
              itemBuilder: (context, index) {
                return InkWell(
                  ...
                  children: [
                    ...
                    Text(
                      '${'please_add_manually_or_collect_promo_from'.tr} ${Get.find<EQSplashControllerEquip>().configModel!.businessName!}',
