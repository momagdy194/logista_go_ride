          ...
          children: [
            Container(
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                Image.asset(Get.find<EQThemeController>().darkTheme ? Images.congratulationDark : Images.congratulationLight, width: 100, height: 100),
                ...
                Padding(
                  ...
                  child: Text(
                    '${'you_will_earn'.tr} ${Get.find<EQAuthController>().getEarningPint()} ${'points_after_completing_this_order'.tr}',
                ...
                CustomButton(
                  ...
                  onPressed: (){
                    Get.find<EQAuthController>().saveEarningPoint('');
                    Get.back();
