...
import 'package:customer/equipment/view/screens/location/widget/web_landing_page.dart';
          ...
          return (ResponsiveHelper.isDesktop(context) && locationController.getUserAddress() == null) ? WebLandingPage(
            ...
            child: FooterView(child: SizedBox( width: 700,
                child: Column(mainAxisAlignment: MainAxisAlignment.center,children: [
                  ...
                  Padding(
                    padding: ResponsiveHelper.isWeb() ? EdgeInsets.zero :   EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeLarge),
...
class BottomButton extends StatelessWidget {
  final EQLocationController locationController;
  final bool fromSignUp;
  final String? route;
  ...
  Widget build(BuildContext context) {
    return Center(child: SizedBox(width: 700, child: Column(children: [
      ...
      CustomButton(
        ...
        onPressed: () async {
          Get.find<EQLocationController>().checkPermission(() async {
            Get.dialog(const CustomLoader(), barrierDismissible: false);
            AddressModel address = await Get.find<EQLocationController>().getCurrentLocation(true);
