...
import 'package:customer/equipment/view/screens/location/widget/landing_card.dart';
import 'package:customer/equipment/view/screens/location/widget/registration_card.dart';
...
class _WebLandingPageState extends State<WebLandingPage> {
  ...
  final ConfigModel? _config = Get.find<EQSplashControllerEquip>().configModel;
  Timer? _timer;
  bool? _isRtl;
  ...
  void initState() {
    ...
    if(Get.find<EQSplashControllerEquip>().moduleList == null) {
      Get.find<EQSplashControllerEquip>().getModules(headers: {'Content-Type': 'application/json; charset=UTF-8'});
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      child: FooterView(child: SizedBox(width: Dimensions.webMaxWidth, child: GetBuilder<EQSplashControllerEquip>(
                    ...
                    child: Row(children: [
                      Expanded(child: TypeAheadField(
                          ...
                          decoration: InputDecoration(
                            ...
                            suffixIcon: IconButton(
                              onPressed: () async {
                                ...
                                _address = await Get.find<EQLocationController>().getCurrentLocation(true);
                        ...
                        onSuggestionSelected: (PredictionModel suggestion) async {
                          ...
                          _address = await Get.find<EQLocationController>().setLocation(suggestion.placeId, suggestion.description, null);
                        },
                      )),
                        ...
                        onPressed: () async {
                          if(_address != null && _controller.text.trim().isNotEmpty) {
                            ...
                            if(response.isSuccess) {
                              Get.find<EQLocationController>().saveAddressAndNavigate(
            ...
            GetBuilder<EQSplashControllerEquip>(builder: (splashController) {
              ...
              return splashController.moduleList != null ? SizedBox(height: 450, child: Stack(children: [
                ...
                Positioned(top: 0, left: 0, child: SizedBox(height: 75, child: Container(
                  padding:   EdgeInsets.only(top: Dimensions.paddingSizeSmall, left: Dimensions.paddingSizeSmall),
                  decoration: BoxDecoration(
  ...
  List<Widget> _generateChooseUsList(EQSplashControllerEquip splashController) {
