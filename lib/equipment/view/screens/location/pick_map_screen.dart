...
class _PickMapScreenState extends State<PickMapScreen> {
  ...
  void initState() {
    ...
    if(widget.fromAddAddress) {
      Get.find<EQLocationController>().setPickData();
    }
          ...
          return Stack(children: [
            ...
            GoogleMap(
              ...
              onMapCreated: (GoogleMapController mapController) {
                ...
                if(!widget.fromAddAddress) {
                  Get.find<EQLocationController>().getCurrentLocation(false, mapController: mapController);
                }
              },
              ...
              onCameraIdle: () {
                Get.find<EQLocationController>().updatePosition(_cameraPosition, false);
              },
            ),
            ...
            Positioned(
              ...
              child: FloatingActionButton(
                ...
                onPressed: () => Get.find<EQLocationController>().checkPermission(() {
                  Get.find<EQLocationController>().getCurrentLocation(false, mapController: _mapController);
                }),
