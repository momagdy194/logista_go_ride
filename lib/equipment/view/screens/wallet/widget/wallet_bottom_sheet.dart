...
class _WalletBottomSheetState extends State<WalletBottomSheet> {
  ...
  int? exchangePointRate = Get.find<EQSplashControllerEquip>().configModel!.loyaltyPointExchangeRate ?? 0;
  int? minimumExchangePoint = Get.find<EQSplashControllerEquip>().configModel!.minimumPointToTransfer ?? 0;
                    ...
                    return !walletController.isLoading ? CustomButton(
                      ...
                      onPressed: () {
                        if(_amountController.text.isEmpty) {
                          ...
                          int? point = Get.find<EQUserController>().userInfoModel!.loyaltyPoint;
