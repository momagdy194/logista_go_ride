...
import 'package:customer/equipment/view/screens/taxi_booking/widgets/trip_info_widget.dart';
...
class _SelectCarScreenState extends State<SelectCarScreen> {
  ...
  void initState() {
    ...
    Get.find<EQCarSelectionController>().getBrandList();
    Get.find<EQCarSelectionController>().getVehiclesList(widget.filterBody, 1);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<EQCarSelectionController>(
                ...
                child: Padding(
                  ...
                  child: CustomButton(
                    ...
                    onPressed: () {
                      ...
                      carSelectionController.carFilter();
                      Get.find<EQCarSelectionController>().getVehiclesList(filterBody, 1);
                    },
                  ),
                ),
              ),
