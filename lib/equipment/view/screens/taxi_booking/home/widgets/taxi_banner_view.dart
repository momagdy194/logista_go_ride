            ...
            SizedBox(
              ...
              child: CarouselSlider.builder(
                ...
                itemBuilder: (context, index, _) {
                  String? baseUrl = bannerDataList![index] is BasicCampaignModel ? Get.find<EQSplashControllerEquip>()
                  ...
                  return InkWell(
                    ...
                    child: Container(
                      ...
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(Dimensions.radiusSmall),
                        child: GetBuilder<EQSplashControllerEquip>(builder: (splashController) {
                          return CustomImage(
