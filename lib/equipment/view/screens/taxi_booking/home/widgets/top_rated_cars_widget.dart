          ...
          builder: (riderController) {
            return riderController.topRatedVehicleModel != null && riderController.topRatedVehicleModel!.vehicles!.isNotEmpty ? SizedBox(
              ...
              child: ListView.builder(
                ...
                return Padding(
                  padding:   EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeExtraSmall, vertical: 5),
                  child: InkWell(
                                    ...
                                    Stack(
                                      children: [
                                        ClipRRect(
                                          ...
                                          child: CustomImage(
                                              image: '${Get.find<EQSplashControllerEquip>().configModel!.baseUrls!.vehicleImageUrl}/${riderController.topRatedVehicleModel!.vehicles![index].carImages!.isNotEmpty
                              ...
                              Row(
                                children: [
                                  ClipRRect(
                                      ...
                                      child: CustomImage(height: 18, width: 18, image: '${Get.find<EQSplashControllerEquip>().configModel!.baseUrls!.vehicleImageUrl}/'
