...
import 'package:customer/equipment/view/screens/taxi_booking/home/widgets/rider_app_bar.dart';
import 'package:customer/equipment/view/screens/taxi_booking/home/widgets/taxi_banner_view.dart';
...
class _RiderHomeScreenState extends State<RiderHomeScreen> {
  ...
  void initState() {
    ...
    Get.find<EQRiderController>().getTopRatedVehiclesList(1);
    Get.find<EQBannerController>().getTaxiBannerList(false);
    if(_isLoggedIn && Get.find<EQUserController>().userInfoModel == null) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<EQLocationController>(builder: (locationController) {
        return Stack(clipBehavior: Clip.none, children: [

          RefreshIndicator(
            onRefresh: ()async {
              await Get.find<EQBannerController>().getTaxiBannerList(false);
              await Get.find<EQRiderController>().getTopRatedVehiclesList(1, isUpdate: true);
            },
