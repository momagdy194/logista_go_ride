...
class _TaxiCouponScreenState extends State<TaxiCouponScreen> {
  ...
  initCall(){
    if(_isLoggedIn) {
      Get.find<EQCouponController>().getTaxiCouponList();
    }
  }
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: _isLoggedIn ? GetBuilder<EQCouponController>(builder: (couponController) {
                            ...
                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                              ...
                              Text(
                                '${couponController.taxiCouponList![index].discount}${couponController.taxiCouponList![index].discountType == 'percent' ? '%'
                                    : Get.find<EQSplashControllerEquip>().configModel!.currencySymbol} off',
