...
import 'package:customer/equipment/view/screens/taxi_booking/select_map_location/widgets/dotted_line.dart';
import 'package:customer/equipment/view/screens/taxi_booking/select_map_location/widgets/pick_and_destination_address_info.dart';
            ...
            children: [
              Container(
                ...
                child: Row(
                  children: [
                    CustomImage(
                      width: 48, height: 46,
                      image: '${Get.find<EQSplashControllerEquip>().configModel!.baseUrls!.vehicleImageUrl}/${widget.vehicle.carImages!.isNotEmpty ? widget.vehicle.carImages![0] : ''}',
                    ),
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            CustomImage(
                              width: 20, height: 20,
                              image: '${Get.find<EQSplashControllerEquip>().configModel!.baseUrls!.vehicleBrandImageUrl}/${''}',
                            ),
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: GetBuilder<EQCouponController>(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      border: OutlineInputBorder(
                                        borderRadius: BorderRadius.horizontal(
                                          left: Radius.circular(Get.find<EQLocalizationController>().isLtr ? 10 : 0),
                                          right: Radius.circular(Get.find<EQLocalizationController>().isLtr ? 0 : 10),
                                        ),
                              ...
                              InkWell(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    borderRadius: BorderRadius.horizontal(
                                      left: Radius.circular(Get.find<EQLocalizationController>().isLtr ? 0 : 10),
                                      right: Radius.circular(Get.find<EQLocalizationController>().isLtr ? 10 : 0),
                                    ),
                                  ),
