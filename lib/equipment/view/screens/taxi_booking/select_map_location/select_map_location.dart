...
import 'package:customer/equipment/view/screens/taxi_booking/select_map_location/widgets/rider_address_input_field.dart';
...
class _SelectMapLocationState extends State<SelectMapLocation> {
  ...
  void initState() {
    ...
    Get.find<EQRiderController>().initializeData(widget.riderType, widget.address);
    Get.find<EQRiderController>().getInitialLocation(widget.address);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<EQRiderController>(
  ...
  Widget expandableContent(RiderType riderType, EQRiderController riderController, Vehicles? vehicle){
    if (kDebugMode) {
    ...
    switch (riderType) {
      ...
      default:
        return GetBuilder<EQRiderController>(
          builder: (riderController) {
            if (kDebugMode) {
