...
class CarFilterWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<EQCarSelectionController>(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text.rich(
                          TextSpan(
                            children: [
                              TextSpan(text: '${Get.find<EQSplashControllerEquip>().configModel!.currencySymbol}', style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                              TextSpan(
                          ...
                          child: InkWell(
                            ...
                            child: Container(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: CustomImage(
                                      image: '${Get.find<EQSplashControllerEquip>().configModel!.baseUrls!.vehicleBrandImageUrl}/${carSelectionController.brandModels![index].logo}',
                                  ),
                                ),
                            ),
                          ),
