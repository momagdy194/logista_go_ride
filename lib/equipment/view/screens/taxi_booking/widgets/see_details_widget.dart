...
class _SeeDetailsWidgetState extends State<SeeDetailsWidget> {
  ...
  void initState() {
    super.initState();
    Get.find<EQRiderController>().setFromToMarker(
      from: LatLng(double.parse(Get.find<EQRiderController>().fromAddress!.latitude!), double.parse(Get.find<EQRiderController>().fromAddress!.longitude!)),
      to: LatLng(double.parse(Get.find<EQRiderController>().toAddress!.latitude!), double.parse(Get.find<EQRiderController>().toAddress!.longitude!)),
    );
  }
  @override
  Widget build(BuildContext context) {
    return Container(
      ...
      child: GetBuilder<EQRiderController>(
