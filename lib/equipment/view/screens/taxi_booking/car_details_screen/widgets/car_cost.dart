        ...
        Text.rich(
          TextSpan(
            ...
            children: [
              ...
              TextSpan(
                  text: insideCityCost.toStringAsFixed(Get.find<EQSplashControllerEquip>().configModel!.digitAfterDecimalPoint!),
        ...
        Text.rich(
          TextSpan(
            ...
            children: [
              ...
              TextSpan(
                  text: outsideCityCost.toStringAsFixed(Get.find<EQSplashControllerEquip>().configModel!.digitAfterDecimalPoint!),
