...
class _InterestScreenState extends State<InterestScreen> {
  ...
  void initState() {
    ...
    Get.find<EQCategoryController>().getCategoryList(true, allCategory: true);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: GetBuilder<EQCategoryController>(builder: (categoryController) {
                        ...
                        child: Container(
                          ...
                          child: Row(children: [
                            ClipRRect(
                              borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
                              child: CustomImage(
                                image: '${Get.find<EQSplashControllerEquip>().configModel!.baseUrls!.categoryImageUrl}'
