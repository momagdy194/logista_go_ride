...
class _StoreItemSearchScreenState extends State<StoreItemSearchScreen> {
  ...
  void initState() {
    ...
    Get.find<EQStoreController>().initSearchData();
  }
                      ...
                      Expanded(
                        ...
                        decoration: InputDecoration(
                          ...
                          suffixIcon: IconButton(
                            ...
                            onPressed: () => Get.find<EQStoreController>()
                                .getStoreSearchItemList(
                              _searchController.text.trim(),
                              widget.storeID,
                              1,
                              Get.find<EQStoreController>().searchType,
                            ),
                          ),
                        ),
                        onSubmitted: (text) =>
                            Get.find<EQStoreController>().getStoreSearchItemList(
                          _searchController.text.trim(),
                          widget.storeID,
                          1,
                          Get.find<EQStoreController>().searchType,
