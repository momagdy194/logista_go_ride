...
class StoreDescriptionView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    bool isAvailable = Get.find<EQStoreController>().isStoreOpenNow(store!.active!, store!.schedules);
      ...
      Row(children: [
        ...
        InkWell(
          onTap: () => Get.toNamed(RouteHelper.getMapRoute(
            ...
            ), 'store', Get.find<EQSplashControllerEquip>().getModuleConfig(Get.find<EQSplashControllerEquip>().module!.moduleType!).newVariation!
          )),
          child: Column(children: [
