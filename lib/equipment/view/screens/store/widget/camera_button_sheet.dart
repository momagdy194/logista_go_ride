        ...
        Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
          InkWell(
            onTap: (){
              ...
              Get.find<EQStoreController>().pickPrescriptionImage(isRemove: false, isCamera: true);
            },
          ...
          InkWell(
            onTap: () {
              ...
              Get.find<EQStoreController>().pickPrescriptionImage(isRemove: false, isCamera: false);
            },
            child: Column(children: [
              Container(
                padding:   EdgeInsets.all(Dimensions.paddingSizeLarge),
