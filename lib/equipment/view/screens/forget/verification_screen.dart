        ...
        child: FooterView(child: Container(
          ...
          child: GetBuilder<EQAuthController>(builder: (authController) {
            return Column(children: [
              ...
              Get.find<EQSplashControllerEquip>().configModel!.demo! ? Text(
              ...
              Padding(
                padding:   EdgeInsets.symmetric(horizontal: 39, vertical: 35),
                      ...
                      authController.verifyPhone(_number, widget.token).then((value) {
                        if(value.isSuccess) {
                          ...
                          Future.delayed(const Duration(seconds: 2), () {
                            Get.find<EQLocationController>().navigateToLocationScreen('verification', offAll: true);
                          });
                        }else {
                          showCustomSnackBar(value.message);
                        }
