...
class ItemTitleView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    double? discount =
        (Get.find<EQItemController>().item!.availableDateStarts != null ||
                Get.find<EQItemController>().item!.storeDiscount == 0)
            ? Get.find<EQItemController>().item!.discount
            : Get.find<EQItemController>().item!.storeDiscount;
    String? discountType =
        (Get.find<EQItemController>().item!.availableDateStarts != null ||
                Get.find<EQItemController>().item!.storeDiscount == 0)
            ? Get.find<EQItemController>().item!.discountType
            : 'percent';
    ...
    return ResponsiveHelper.isDesktop(context)
        ...
        : Container(
            ...
            child: GetBuilder<EQItemController>(
