...
class ItemImageView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<EQItemController>(
      builder: (itemController) {
        String? baseUrl = item!.availableDateStarts == null ? Get.find<EQSplashControllerEquip>().
  ...
  List<Widget> _indicators(BuildContext context, EQItemController itemController, List<String?> imageList) {
