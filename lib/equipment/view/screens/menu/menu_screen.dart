...
import 'package:customer/equipment/view/screens/menu/widget/menu_button.dart';
...
class _MenuScreenState extends State<MenuScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if(Get.find<EQSplashControllerEquip>().configModel!.toggleDmRegistration! && !ResponsiveHelper.isDesktop(context)) {
    ...
    if(Get.find<EQSplashControllerEquip>().configModel!.toggleStoreRegistration! && !ResponsiveHelper.isDesktop(context)) {
      _menuList.add(MenuModel(
