...
class MessageBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    BaseUrls? baseUrl = Get.find<EQSplashControllerEquip>().configModel!.baseUrls;
    bool isReply = message.senderId != Get.find<EQUserController>().userInfoModel!.userInfo!.id;

    return (isReply) ? Container(
      margin:   EdgeInsets.symmetric(horizontal: 0.0, vertical: Dimensions.paddingSizeDefault),
      ...
      decoration: BoxDecoration(borderRadius: BorderRadius.circular(Dimensions.paddingSizeSmall)),
      child: GetBuilder<EQUserController>(builder: (profileController) {
