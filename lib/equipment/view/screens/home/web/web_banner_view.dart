...
class WebBannerView extends StatelessWidget {
  final EQBannerController bannerController;
          ...
          Padding(
            ...
            child: PageView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                String? baseUrl1 = bannerController.bannerDataList![index1] is BasicCampaignModel ? Get.find<EQSplashControllerEquip>()
                    .configModel!.baseUrls!.campaignImageUrl : Get.find<EQSplashControllerEquip>().configModel!.baseUrls!.bannerImageUrl;
                String? baseUrl2 = hasSecond ? bannerController.bannerDataList![index2] is BasicCampaignModel ? Get.find<EQSplashControllerEquip>()
                    .configModel!.baseUrls!.campaignImageUrl : Get.find<EQSplashControllerEquip>().configModel!.baseUrls!.bannerImageUrl : '';
                return Row(children: [
  ...
  void _onTap(int index, BuildContext context) async {
    if(bannerController.bannerDataList![index] is Item) {
      ...
      Get.find<EQItemController>().navigateToItemPage(item, context);
