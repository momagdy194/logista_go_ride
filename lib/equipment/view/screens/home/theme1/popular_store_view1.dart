      ...
      return (storeList != null && storeList.isEmpty) ? const SizedBox() : Column(
        children: [
          Padding(
            ...
            child: TitleWidget(
              title: isFeatured ? 'featured_stores'.tr : isPopular ? Get.find<EQSplashControllerEquip>().configModel!.moduleConfig!.module!.showRestaurantText!
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [BoxShadow(
                          color: Colors.grey[Get.find<EQThemeController>().darkTheme ? 800 : 300]!,
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                        ...
                        Stack(children: [
                          ClipRRect(
                            ...
                            child: CustomImage(
                              image: '${Get.find<EQSplashControllerEquip>().configModel!.baseUrls!.storeCoverPhotoUrl}'
                          ...
                          Positioned(
                            ...
                            child: GetBuilder<EQWishListController>(builder: (wishController) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index){
        return Container(
          height: 150,
          width: 200,
          margin:   EdgeInsets.only(right: Dimensions.paddingSizeSmall, bottom: 5),
          decoration: BoxDecoration(
              color: Colors.white,
              borderRadius: BorderRadius.circular(Dimensions.radiusSmall),
