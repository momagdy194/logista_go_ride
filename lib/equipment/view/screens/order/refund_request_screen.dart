...
class _RefundRequestScreenState extends State<RefundRequestScreen> {
  ...
  void initState() {
    super.initState();
    Get.find<EQOrderController>().selectReason(0, isUpdate: false);
    Get.find<EQOrderController>().pickRefundImage(true);
    Get.find<EQOrderController>().getRefundReasons();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<EQOrderController>(
