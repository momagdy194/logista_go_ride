...
import 'package:customer/equipment/view/screens/order/widget/order_shimmer.dart';
              ...
              child: SizedBox(
                ...
                child: PaginatedListView(
                  ...
                  onPaginate: (int? offset) {
                    if(isRunning) {
                      Get.find<EQOrderController>().getRunningOrders(offset!, isUpdate: true);
                    }else {
                      Get.find<EQOrderController>().getHistoryOrders(offset!, isUpdate: true);
                    }
                  },
                  ...
                  itemView: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return InkWell(
                        ...
                        child: Container(
                          padding: ResponsiveHelper.isDesktop(context) ?   EdgeInsets.all(Dimensions.paddingSizeSmall) : null,
                          margin: ResponsiveHelper.isDesktop(context) ?   EdgeInsets.only(bottom: Dimensions.paddingSizeSmall) : null,
                              ...
                              Stack(children: [
                                Container(
                                  ...
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(Dimensions.radiusSmall),
                                    child: CustomImage(
                                      image: isParcel ? '${Get.find<EQSplashControllerEquip>().configModel!.baseUrls!.parcelCategoryImageUrl}'
                                          '/${paginatedOrderModel.orders![index].parcelCategory != null ? paginatedOrderModel.orders![index].parcelCategory!.image : ''}'
                                          : '${Get.find<EQSplashControllerEquip>().configModel!.baseUrls!.storeImageUrl}/${paginatedOrderModel.orders![index].store != null
