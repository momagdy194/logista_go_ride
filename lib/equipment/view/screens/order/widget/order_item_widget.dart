  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ClipRRect(
            ...
            child: CustomImage(
              ...
              image: '${orderDetails.itemCampaignId != null ? Get.find<EQSplashControllerEquip>().configModel!.baseUrls!.campaignImageUrl
          ...
          Expanded(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Row(children: [
                ...
                ((Get.find<EQSplashControllerEquip>().configModel!.moduleConfig!.module!.unit! && orderDetails.itemDetails!.unitType != null)
                || (Get.find<EQSplashControllerEquip>().configModel!.moduleConfig!.module!.vegNonVeg! && Get.find<EQSplashControllerEquip>().configModel!.toggleVegNonVeg!)) ? Container(
                  ...
                  child: Text(
                    !Get.find<EQSplashControllerEquip>().getModuleConfig(order.moduleType).newVariation! ? orderDetails.itemDetails!.unitType ?? ''
        ...
        (Get.find<EQSplashControllerEquip>().getModuleConfig(order.moduleType).addOn! && addOnText.isNotEmpty) ? Padding(
