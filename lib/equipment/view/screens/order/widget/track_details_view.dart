...
import 'package:customer/equipment/view/base/custom_divider.dart';
...
import 'package:customer/equipment/view/screens/order/widget/address_details.dart';
    ...
    return Container(
      ...
      child: (!takeAway && track.deliveryMan == null) ? Padding(
        ...
        Align(alignment: Alignment.centerLeft, child: Text(
          takeAway ? Get.find<EQSplashControllerEquip>().configModel!.moduleConfig!.module!.showRestaurantText!
        ...
        Row(children: [
          ClipOval(child: CustomImage(
            image: '${takeAway ? Get.find<EQSplashControllerEquip>().configModel!.baseUrls!.storeImageUrl
                : Get.find<EQSplashControllerEquip>().configModel!.baseUrls!.deliveryManImageUrl}/${takeAway ? track.store != null ? track.store!.logo : ''
