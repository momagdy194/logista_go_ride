...
import 'package:customer/equipment/data/model/body/translation.dart';
...
import 'package:customer/equipment/view/screens/auth/widget/custom_time_picker.dart';
import 'package:customer/equipment/view/screens/auth/widget/pass_view.dart';
import 'package:customer/equipment/view/screens/auth/widget/select_location_view.dart';
...
class _StoreRegistrationScreenState extends State<StoreRegistrationScreen> {
  ...
  final List<Language>? _languageList = Get.find<EQSplashControllerEquip>().configModel!.language;
  ...
  void initState() {
    ...
    Get.find<EQAuthController>().storeStatusChange(0.4, isUpdate: false);
    Get.find<EQAuthController>().getZoneList();
    Get.find<EQAuthController>().selectModuleIndex(-1, canUpdate: false);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: 'store_registration'.tr, onBackPressed: (){
        if(Get.find<EQAuthController>().dmStatus == 0.4 && firstTime){
          Get.find<EQAuthController>().storeStatusChange(0.4);
          firstTime = false;
        }else{
          Get.back();
        }
          ...
          return Column(children: [
            ...
            Expanded(
              child: SingleChildScrollView(
                  padding: ResponsiveHelper.isDesktop(context) ? EdgeInsets.zero :   EdgeInsets.symmetric(vertical: Dimensions.paddingSizeSmall, horizontal: Dimensions.paddingSizeDefault),
                  child: FooterView(
  ...
  Widget webView(EQAuthController authController){
    return Column(children: [
      Container(
          decoration: BoxDecoration(
            color: Theme.of(context).cardColor,
