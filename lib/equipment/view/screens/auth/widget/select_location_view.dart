...
import 'package:customer/equipment/view/screens/auth/widget/module_view.dart';
import 'package:customer/equipment/view/screens/location/widget/location_search_dialog.dart';
...
class _SelectLocationViewState extends State<SelectLocationView> {
  ...
  Widget webView(EQAuthController authController, List<DropdownItem<int>> zoneList) {
    return Row(children: [
  ...
  Widget zoneSection(EQAuthController authController, List<DropdownItem<int>> zoneList) {
  ...
  Widget mapView(EQAuthController authController) {
