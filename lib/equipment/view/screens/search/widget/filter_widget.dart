...
import 'package:customer/equipment/view/screens/search/widget/custom_check_box.dart';
        ...
        child: GetBuilder<EQSearchingController>(builder: (searchController) {
          return SingleChildScrollView(
            child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              const SizedBox(height: Dimensions.paddingSizeSmall),
              (Get.find<EQSplashControllerEquip>().configModel!.toggleVegNonVeg!
              && Get.find<EQSplashControllerEquip>().configModel!.moduleConfig!.module!.vegNonVeg!) ? CustomCheckBox(
                title: 'veg'.tr,
              ...
              CustomCheckBox(
                title: isStore ? Get.find<EQSplashControllerEquip>().configModel!.moduleConfig!.module!.showRestaurantText!
