...
import 'package:customer/equipment/view/screens/review/widget/deliver_man_review_widget.dart';
import 'package:customer/equipment/view/screens/review/widget/item_review_widget.dart';
...
class RateReviewScreenState extends State<RateReviewScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    Get.find<EQItemController>().initRatingData(widget.orderDetailsList);
  }
  @override
