          ...
          Expanded(
            child: Scrollbar(
              child: GetBuilder<EQLocationController>(builder: (locationController) {
                ...
                //   }
                // }
                return Get.find<EQAuthController>().isLoggedIn() ? locationController.addressList != null ? locationController.addressList!.isNotEmpty ? ListView.builder(
                    ...
                    if(locationController.getUserAddress()!.zoneIds!.contains(locationController.addressList![index].zoneId)) {
                      return Center(child: SizedBox(width: 700, child: AddressWidget(
                        ...
                        onTap: () {
                          ...
                          if(Get.find<EQParcelController>().isSender){
                            Get.find<EQParcelController>().setPickupAddress(address, true);
                            Get.back();
                          }else{
