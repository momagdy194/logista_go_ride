...
class _ReceiverDetailsBottomSheetState extends State<ReceiverDetailsBottomSheet> {
  ...
  void initState() {
    ...
    _streetNumberController.text = Get.find<EQParcelController>().destinationAddress!.streetNumber!;
    _houseController.text = Get.find<EQParcelController>().destinationAddress!.house!;
    _floorController.text = Get.find<EQParcelController>().destinationAddress!.floor!;
  }
          ...
          CustomButton(
            ...
            onPressed: () {
              ...
              if(name.isEmpty) {
                ...
                AddressModel address = Get.find<EQParcelController>().destinationAddress!;
                ...
                Get.find<EQParcelController>().setDestinationAddress(address);
                AddressModel pickedAddress = Get.find<EQParcelController>().pickupAddress!;
                if((pickedAddress.contactPersonName == null || pickedAddress.contactPersonName!.isEmpty)
                    && Get.find<EQUserController>().userInfoModel != null) {
                  pickedAddress.contactPersonName = '${Get.find<EQUserController>().userInfoModel!.fName}'
                ...
                if((pickedAddress.contactPersonNumber == null || pickedAddress.contactPersonNumber!.isEmpty)
                    && Get.find<EQUserController>().userInfoModel != null) {
                  pickedAddress.contactPersonNumber = Get.find<EQUserController>().userInfoModel!.phone;
                }
