...
import 'package:customer/equipment/view/screens/parcel/widget/address_dialog.dart';
...
class _ParcelViewState extends State<ParcelView> {
  ...
  Widget build(BuildContext context) {
    return SizedBox(width: Dimensions.webMaxWidth, child: GetBuilder<EQParcelController>(builder: (parcelController) {
