...
import 'package:customer/equipment/view/screens/profile/widget/profile_button.dart';
import 'package:customer/equipment/view/screens/profile/widget/profile_card.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    final bool showWalletCard = Get.find<EQSplashControllerEquip>().configModel!.customerWalletStatus == 1
        || Get.find<EQSplashControllerEquip>().configModel!.loyaltyPointStatus == 1;
                ...
                child: Container(
                  ...
                  child: Center(
                    child: Column(children: [
                      ...
                      Padding(
                        padding:   EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeExtremeLarge, vertical: Dimensions.paddingSizeExtremeLarge),
                        child: Row(children: [
                        ...
                        child: Container(
                          ...
                          child: Column(children: [
                            ...
                            (showWalletCard && isLoggedIn) ? Row(children: [
                              ...
                              Get.find<EQSplashControllerEquip>().configModel!.loyaltyPointStatus == 1 ? Expanded(child: ProfileCard(
                              ...
                              SizedBox(width: Get.find<EQSplashControllerEquip>().configModel!.loyaltyPointStatus == 1 ? Dimensions.paddingSizeSmall : 0),
                              ...
                              SizedBox(width: Get.find<EQSplashControllerEquip>().configModel!.customerWalletStatus == 1 ? Dimensions.paddingSizeSmall : 0),

                              Get.find<EQSplashControllerEquip>().configModel!.customerWalletStatus == 1 ? Expanded(child: ProfileCard(
                            ...
                            ProfileButton(icon: Icons.tonality_outlined, title: 'dark_mode'.tr, isButtonActive: Get.isDarkMode, onTap: () {
                              Get.find<EQThemeController>().toggleTheme();
                            }),
                            const SizedBox(height: Dimensions.paddingSizeSmall),

                            isLoggedIn ? GetBuilder<EQAuthController>(builder: (authController) {
