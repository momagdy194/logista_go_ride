...
class _AddAddressScreenState extends State<AddAddressScreen> {
  ...
  String? _countryDialCode = Get.find<EQAuthController>().getUserCountryCode().isNotEmpty ? Get.find<EQAuthController>().getUserCountryCode()
      : CountryCode.fromCountryCode(Get.find<EQSplashControllerEquip>().configModel!.country!).dialCode;
  ...
  void initCall(){
    ...
    Get.find<EQLocationController>().setAddressTypeIndex(0, isUpdate: false);
    ...
    if(widget.address == null) {
      ...
      Get.find<EQLocationController>().setUpdateAddress(widget.address!);
      _initialPosition = LatLng(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: isLoggedIn ? GetBuilder<EQUserController>(builder: (userController) {
        if(widget.address != null) {
        ...
        return GetBuilder<EQLocationController>(builder: (locationController) {
            ...
            Expanded(child: Scrollbar(child: SingleChildScrollView(
              ...
              child: Center(child: SizedBox(width: Dimensions.webMaxWidth, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                CustomTextField(
                  ...
                  countryDialCode: _countryDialCode ?? Get.find<EQLocalizationController>().locale.countryCode,
                ),
                const SizedBox(height: Dimensions.paddingSizeLarge),
