...
import 'package:customer/equipment/view/base/corner_banner/positioned_banner.dart';
              ...
              children:  [
                Text(
                  discount! > 0 ? '$discount${discountType == 'percent' ? '%'
                      : Get.find<EQSplashControllerEquip>().configModel!.currencySymbol} ${'off'.tr}' : 'free_delivery'.tr,
