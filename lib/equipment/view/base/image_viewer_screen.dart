...
class ImageViewerScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Get.find<EQItemController>().setImageIndex(0, false);
    ...
    return Scaffold(
      ...
      body: GetBuilder<EQItemController>(builder: (itemController) {
            ...
            PhotoViewGallery.builder(
              ...
              builder: (BuildContext context, int index) {
                return PhotoViewGalleryPageOptions(
                  imageProvider: NetworkImage('${Get.find<EQSplashControllerEquip>().configModel!.baseUrls!.itemImageUrl}/${imageList[index]}'),
