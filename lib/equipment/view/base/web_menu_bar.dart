...
import 'package:customer/equipment/view/base/text_hover.dart';
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Center(child: SizedBox(width: Dimensions.webMaxWidth, child: Row(children: [
        ...
        Get.find<EQLocationController>().getUserAddress() != null ? Expanded(child: InkWell(
          onTap: () => Get.find<EQLocationController>().navigateToLocationScreen('home'),
          child: Padding(
            padding:   EdgeInsets.all(Dimensions.paddingSizeSmall),
            child: GetBuilder<EQLocationController>(builder: (locationController) {
        ...
        Get.find<EQLocationController>().getUserAddress() == null ? Row(children: [
        ...
        ]) : SizedBox(width: 250, child: GetBuilder<EQSearchingController>(builder: (searchController) {
        ...
        const SizedBox(width: 20),
        GetBuilder<EQLocalizationController>(builder: (localizationController) {
          int index0 = 0;
  ...
  Widget build(BuildContext context) {
    return TextHover(builder: (hovered) {
      return IconButton(
        ...
        icon: GetBuilder<EQCartController>(builder: (cartController) {
