...
class _ItemBottomSheetState extends State<ItemBottomSheet> {
  ...
  void initState() {
    ...
    if(Get.find<EQSplashControllerEquip>().module == null){
      if(Get.find<EQSplashControllerEquip>().cacheModule != null){
        Get.find<EQSplashControllerEquip>().setCacheConfigModule(Get.find<EQSplashControllerEquip>().cacheModule);
      }
    }
    _newVariation = Get.find<EQSplashControllerEquip>().getModuleConfig(widget.item!.moduleType).newVariation;
    Get.find<EQItemController>().initData(widget.item, widget.cart);
  }
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      // padding:   EdgeInsets.only(left: Dimensions.paddingSizeDefault, bottom: Dimensions.paddingSizeDefault),
      ...
      child: GetBuilder<EQItemController>(builder: (itemController) {
                      ...
                      child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                          ...
                          InkWell(
                            ...
                            child: Stack(children: [
                              ClipRRect(
                                ...
                                child: CustomImage(
                                  image: '${widget.isCampaign ? Get.find<EQSplashControllerEquip>().configModel!.baseUrls!.campaignImageUrl
                                      : Get.find<EQSplashControllerEquip>().configModel!.baseUrls!.itemImageUrl}/${widget.item!.image}',
                              ...
                              InkWell(
                                onTap: () {
                                  if(widget.inStorePage) {
                                    ...
                                    Get.back();
                                    Get.find<EQCartController>().forcefullySetModule(widget.item!.moduleId!);
                                    Get.toNamed(
                          ...
                          Column(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.end, children: [
                            ...
                            widget.isCampaign ? const SizedBox(height: 25) : GetBuilder<EQWishListController>(builder: (wishList) {
                              return InkWell(
                                onTap: () {
                            ...
                            SizedBox(height: Get.find<EQSplashControllerEquip>().configModel!.toggleVegNonVeg! ? 50 : 0),

                            ((Get.find<EQSplashControllerEquip>().configModel!.moduleConfig!.module!.unit! && widget.item!.unitType != null)
                            || (Get.find<EQSplashControllerEquip>().configModel!.moduleConfig!.module!.vegNonVeg! && Get.find<EQSplashControllerEquip>().configModel!.toggleVegNonVeg!)) ? Container(
                              ...
                              child: Get.find<EQSplashControllerEquip>().configModel!.moduleConfig!.module!.unit! ? Text(
                        ...
                        SizedBox(height: (Get.find<EQSplashControllerEquip>().configModel!.moduleConfig!.module!.addOn! && widget.item!.addOns!.isNotEmpty) ? Dimensions.paddingSizeLarge : 0),

                        // Addons
                        (Get.find<EQSplashControllerEquip>().configModel!.moduleConfig!.module!.addOn! && widget.item!.addOns!.isNotEmpty)
                  ...
                  child: Column(children: [
                    ...
                    Row(children: [
                        ...
                        Expanded(child: CustomButton(
                          ...
                          buttonText: (Get.find<EQSplashControllerEquip>().configModel!.moduleConfig!.module!.stock! && stock! <= 0)
                          ...
                          onPressed: (Get.find<EQSplashControllerEquip>().configModel!.moduleConfig!.module!.stock! && stock! <= 0) ? null : () {
                            ...
                            if(invalid != null) {
                              ...
                              if(widget.isCampaign) {
                                ...
                                if (Get.find<EQCartController>().existAnotherStoreItem(cartModel.item!.storeId, Get.find<EQSplashControllerEquip>().module != null ? Get.find<EQSplashControllerEquip>().module!.id : Get.find<EQSplashControllerEquip>().cacheModule!.id)) {
                                  Get.dialog(ConfirmationDialog(
                                    icon: Images.warning,
                                    title: 'are_you_sure_to_reset'.tr,
                                    description: Get.find<EQSplashControllerEquip>().configModel!.moduleConfig!.module!.showRestaurantText!
                                        ? 'if_you_continue'.tr : 'if_you_continue_without_another_store'.tr,
                                    onYesPressed: () {
                                      Get.back();
                                      Get.find<EQCartController>().removeAllAndAddToCart(cartModel);
                                      showCartSnackBar();
                                    },
                                  ), barrierDismissible: false);
                                } else {
                                  Get.find<EQCartController>().addToCart(
