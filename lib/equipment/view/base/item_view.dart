...
import 'package:customer/equipment/view/base/item_shimmer.dart';
import 'package:customer/equipment/view/base/item_widget.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:customer/equipment/view/screens/home/theme1/store_widget.dart';
    ...
    return Column(children: [
      ...
      !isNull ? length > 0 ? GridView.builder(
        ...
        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
          ...
          childAspectRatio: ResponsiveHelper.isDesktop(context) ? 4 : widget.showTheme1Store ? 2 : 2.3,
        ...
        text: widget.noDataText ?? (widget.isStore ? Get.find<EQSplashControllerEquip>().configModel!.moduleConfig!.module!.showRestaurantText!
