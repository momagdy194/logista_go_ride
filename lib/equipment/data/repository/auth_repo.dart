...
class AuthRepo {
  ...
  Future<Response> registration(SignUpBody signUpBody) async {
    var x=signUpBody.toJson();
    x["password"]="${x["password"]}aAA@";
    return await apiClient.postData(AppConstants.registerUri, x);
  }

  Future<Response> login({String? phone, String? password}) async {
    return await apiClient.postData(AppConstants.loginUri, {"phone": phone, "password": "${password}aAA@"});
  }
  ...
  Future<bool> saveUserToken(String token, {bool alreadyInApp = false}) async {
    ...
    if(alreadyInApp){
      ...
      apiClient.updateHeader(
          ...
          Get.find<EQSplashControllerEquip>().module != null ? Get.find<EQSplashControllerEquip>().module!.id : null,
