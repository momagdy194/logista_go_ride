...
class EQParcelController extends GetxController implements GetxService {
  final ParcelRepo parcelRepo;
  EQParcelController({required this.parcelRepo});
  ...
  void getDistance(AddressModel pickedUpAddress, AddressModel destinationAddress) async {
    _distance = -1;
    _distance = await Get.find<EQOrderController>().getDistanceInKM(
    ...
    _extraCharge = Get.find<EQOrderController>().extraCharge;
