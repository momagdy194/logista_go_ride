...
import 'package:customer/equipment/data/model/response/coupon_model.dart';
...
class EQCouponController extends GetxController implements GetxService {
  final CouponRepo couponRepo;
  EQCouponController({required this.couponRepo});
