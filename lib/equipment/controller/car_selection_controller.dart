...
import 'package:customer/equipment/data/model/response/brand_model.dart';
...
class EQCarSelectionController extends GetxController implements GetxService {
  final CarSelectionRepo carSelectionRepo;
  EQCarSelectionController({required this.carSelectionRepo});
