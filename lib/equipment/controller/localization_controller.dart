...
class EQLocalizationController extends GetxController implements GetxService {
  final SharedPreferences sharedPreferences;
  final ApiClient apiClient;

  EQLocalizationController({required this.sharedPreferences, required this.apiClient}) {
    loadCurrentLanguage();
  }
  ...
  void setLanguage(Locale locale) {
    ...
    apiClient.updateHeader(
      ...
      locale.languageCode, Get.find<EQSplashControllerEquip>().module != null ? Get.find<EQSplashControllerEquip>().module!.id : null,
    ...
    if(Get.find<EQLocationController>().getUserAddress() == null) {
      Get.find<EQSplashControllerEquip>().getLandingPageData();
    }
