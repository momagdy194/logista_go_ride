...
class EQSearchingController extends GetxController implements GetxService {
  final SearchRepo searchRepo;
  EQSearchingController({required this.searchRepo});
  ...
  void searchData(String? query, bool fromHome, {year, version_id}) async {
    if ((_isStore && query!.isNotEmpty && query != _storeResultText) ||
        (!_isStore &&
            query!.isNotEmpty &&
            (query != _itemResultText ||
                fromHome ||
                query == _itemResultText))) {
