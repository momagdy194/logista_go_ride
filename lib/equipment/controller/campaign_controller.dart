...
class EQCampaignController extends GetxController implements GetxService {
  final CampaignRepo campaignRepo;
  EQCampaignController({required this.campaignRepo});
    ...
    if(_itemCampaignList == null || reload) {
      ...
      if (response.statusCode == 200) {
        ...
        for (var c in campaign) {
          if(!Get.find<EQSplashControllerEquip>().getModuleConfig(c.moduleType).newVariation!
