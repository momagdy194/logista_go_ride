...
import 'package:customer/equipment/data/model/response/wallet_model.dart';
...
class EQWalletController extends GetxController implements GetxService{
  final WalletRepo walletRepo;
  EQWalletController({required this.walletRepo});
