...
enum EQPageState {orderDetails, payment, complete}
...
class BookingCheckoutController extends GetxController implements GetxService{
  ...
  EQPageState currentPage = EQPageState.orderDetails;
  ...
  void updateState(EQPageState currentPage,{bool shouldUpdate = true}){
    if (kDebugMode) {
      print('--------------$currentPage');
    }
